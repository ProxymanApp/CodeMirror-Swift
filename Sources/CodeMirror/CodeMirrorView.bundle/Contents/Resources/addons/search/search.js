...
(function(mod) {
  ...
  CodeMirror.defineOption("closeFunc", null);
  ...
  function persistentDialog(cm, text, deflt, onEnter, onKeyDown) {
    var closeFunc = cm.openDialog(text, onEnter, {
      value: deflt,
      selectValueOnOpen: true,
      closeOnEnter: false,
      onClose: function() {
        clearSearch(cm);
        cm.options.closeFunc = null;
       },
      onKeyDown: onKeyDown,
      bottom: cm.options.search.bottom
    });
    cm.options.closeFunc = closeFunc;
  }
  ...
  CodeMirror.commands.findPersistent = function(cm) {
    if (cm.options.closeFunc == null) {
//      clearSearch(cm);
      doSearch(cm, false, true);
    } else {
      cm.options.closeFunc();
    }
    };
